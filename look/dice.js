...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-08e88389');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-08e88389');}
...
function clearFlash(){dieView.classList.remove('rl-win-08e88389');dieView.classList.remove('rl-lose-08e88389');if(frameEl){frameEl.classList.remove('rl-win-08e88389');frameEl.classList.remove('rl-lose-08e88389');}}
function flashOutcome(won){clearFlash();if(won){dieView.classList.add('rl-win-08e88389');if(frameEl){frameEl.classList.add('rl-win-08e88389');}}else{dieView.classList.add('rl-lose-08e88389');if(frameEl){frameEl.classList.add('rl-lose-08e88389');}}
...
var brandEl=document.querySelector('.rl-brand-08e88389');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
